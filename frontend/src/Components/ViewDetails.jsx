...
const ViewDetailsModal = () => {
  ...
  const isPatient =
    modalData?.userId?.role === "Patient" ||
    modalData?.bloodGroup ||
    modalData?.medicalHistory;

  const isDoctor =
    modalData?.userId?.role === "Doctor" ||
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-blue-50 rounded-2xl p-4">
                  ...
                  <p className="text-gray-700">
                    {modalData.qualification || "Not specified"}
                  </p>
                </div>
                ...
                <div className="bg-green-50 rounded-2xl p-4">
                  ...
                  <p className="text-gray-700">
                    {modalData.specialization || "Not specified"}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {Array.isArray(modalData.availableDays) &&
                      modalData.availableDays.length > 0 ? (
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">
                      {modalData.userId?.emailAddress || "Not specified"}
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Phone className="w-4 h-4 text-gray-600" />
                    <span className="text-gray-700">
                      {modalData.phoneNumber || "Not specified"}
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <MapPin className="w-4 h-4 text-gray-600" />
                    <span className="text-gray-700">
                      {getLocationDisplay(modalData.location)}
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-blue-50 rounded-2xl p-4">
                  ...
                  <div className="space-y-2">
                    <p>
                      ...
                      {getAge(modalData.dateOfBirth)} years
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      {modalData.bloodGroup || "Not specified"}
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-green-50 rounded-2xl p-4">
                  ...
                  <div className="space-y-2">
                    <p>
                      ...
                      {modalData.medicalHistory ? "Available" : "None"}
                    </p>
                    <p>
                      <span className="text-gray-600">Allergies:</span>{" "}
                      {modalData.allergies?.length || 0}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-red-50 rounded-2xl p-6">
                  ...
                  <div className="space-y-2">
                    <p>
                      ...
                      {modalData.emergencyContact.name || "Not specified"}
                    </p>
                    <p>
                      <span className="text-gray-600">Phone:</span>{" "}
                      {modalData.emergencyContact.phone || "Not specified"}
                    </p>
                    <p>
                      <span className="text-gray-600">Relation:</span>{" "}
                      {modalData.emergencyContact.relation || "Not specified"}
                    </p>
                  </div>
                </div>
              )}
