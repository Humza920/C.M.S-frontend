  ...
  const features = [
    {
      ...
      title: "Easy Booking",
      description:
        "Seamless online appointment scheduling with instant confirmation",
    },
    {
      icon: <Clock className="h-10 w-10" />,
      title: "Flexible Timings",
      description:
        "Open Monday to Saturday, 10:00 AM - 8:00 PM for your convenience",
    },
    {
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-white shadow-lg border border-blue-100"
              >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 shadow-2xl">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Book your appointment today and experience healthcare that puts
              you first
            </p>
            <Link
              to="/our-doctors"
