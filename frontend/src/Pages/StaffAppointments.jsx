    ...
    <div className="min-h-screen bg-gray-50 pt-20 pb-10">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-3">All Appointments</h1>
          <p className="text-gray-600">Manage and track all appointments as Staff</p>
        </div>
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 mb-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-blue-600 font-medium mb-1">{app.doctorId?.specialization || "Specialist"}</p>
                        <p className="text-gray-600 text-sm">{app.doctorId?.qualification}</p>

                        <p className="text-gray-700 text-sm mt-1">
                          Patient: {app.patientId?.userId?.userName || "-"} ({app.patientId?.userId?.emailAddress || "-"})
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-900">{app.startAt} - {app.endAt}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-900">{app.doctorId?.location?.country || "Online Consultation"}</p>
                      </div>
                    </div>
                  </div>
